...
@Bean
public CommandLineRunner initData(PlayerRepository repository, GameRepository repository1, GamePlayerRepository repository2, ShipRepository repository3ship, SalvoRepository repository4salvo) {
	return (args) -> {
...
//game2
	  ...
	  /*repository2.save(new GamePlayer(game2, player2));
		repository2.save(new GamePlayer(game2, player3));
